...
func main() {
	...
	common.New(&common.App{"hl7send", "1.0.2", "2018", "Send HL7/TXT files", "mpetavy", common.APACHE, "https://github.com/mpetavy/hl7send", false, nil,nil, nil, run, time.Duration(9)}, []string{"f"})
	common.Run()
}
